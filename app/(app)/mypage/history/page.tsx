          ...
          <div key={h.testedAt} className="rounded-[12px] bg-card border border-border/60 p-3.5">
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 text-center">
              <div>
                ...
                <div className="text-lg font-extrabold">{h.lowestNote}</div>
              </div>
              <div>
                <div className="text-[10px] text-muted-foreground">편한 고음</div>
                <div className="text-lg font-extrabold">{h.comfortableHigh}</div>
              </div>
              <div>
                <div className="text-[10px] text-muted-foreground">최고</div>
                <div className="text-lg font-extrabold text-brand">{h.highestNote}</div>
              </div>
            </div>
          </div>
        ))}
